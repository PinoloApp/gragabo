...
import legalData from '@/data/LegalNoticeData.json';
            ...
            <section className="tc-hero">
                <div className="tc-hero-content">
                    <h1 className="tc-title">
                        Legal <span className="tc-gold">Notice</span>
                    </h1>
                    <p className="tc-subtitle">
                        Official compliance framework and corporate governance documentation.
                    </p>
                </div>
            </section>
