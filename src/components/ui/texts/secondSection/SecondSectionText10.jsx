...
export const SecondSectionText10 = forwardRef(({ isMobile, ...props }, ref) => {
    return (
        <div
            ref={ref}
            className={isMobile
        ...
        >
            <h2 className={`font-sans font-black ${isMobile ? "text-xl text-black" : "text-2xl md:text-3xl text-white"}`}>
                <span className={`text-[#0A6B3B] font-normal block mb-2 ${isMobile ? "text-base" : "text-lg"}`}>Phase Three:</span>Ongoing Advisory and Monitoring
            </h2>
