...
import termsData from '@/data/TermsAndConditionsData.json';
            ...
            <section className="tc-hero">
                <div className="tc-hero-content">
                    <h1 className="tc-title">
                        Terms & <span className="tc-gold">Conditions</span>
                    </h1>
                    <p className="tc-subtitle">
                        Comprehensive overview of our governing policies, general provisions, and legal framework.
                    </p>
                </div>
            </section>
