            ...
            <section className="tc-hero">
                <div className="tc-hero-content">
                    <h1 className="tc-title">
                        Cookie <span className="tc-gold">Policy</span>
                    </h1>
                    <p className="tc-subtitle">
                        Transparent, comprehensive, and legally compliant information regarding the collection, storage, and use of cookies.
                    </p>
                </div>
            </section>

            {/* DYNAMIC CONTENT SECTIONS */}
            {cookieData.map((section, idx) => {
